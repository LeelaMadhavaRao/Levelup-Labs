...
export default function CreateCoursePage() {
  ...
  const addModule = () => {
    setModules([
      ...modules,
      { id: crypto.randomUUID(), name: '', description: '', topics: [] },
    ]);
  };
      ...
      modules.map((m) =>
        m.id === moduleId
          ? {
              ...
              topics: [
                ...m.topics,
                { id: crypto.randomUUID(), name: '', video_url: '', description: '', overview: '' },
              ],
            }
          : m
      )
    ...
    <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8 space-y-8">
      ...
      <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">
            Add modules, topics, and publish a new learning course.
          </p>
        </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          <Card className="border-gray-200 bg-white text-gray-900 lg:col-span-2">
            <CardHeader>
              <CardTitle>Course Details</CardTitle>
              <CardDescription className="text-gray-500">Basic information about the course</CardDescription>
            </CardHeader>
          ...
          <Card className="border-gray-200 bg-white text-gray-900">
            <CardHeader>
              ...
              <CardDescription className="text-gray-500">Before publishing</CardDescription>
            </CardHeader>
            <CardContent className="space-y-3 text-sm text-gray-600">
              ...
              <div className="rounded-lg border border-gray-200 bg-gray-50 p-3">
                Write overviews so AI can generate stronger quizzes and coding problems.
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Button type="button" onClick={addModule} variant="outline" className="border-gray-200 text-gray-600 hover:bg-gray-100">
          ...
          {modules.map((module, moduleIndex) => (
            <Card key={module.id} className="border-gray-200 bg-white text-gray-900">
              <CardHeader>
                <div className="flex items-center justify-between">
                  <CardTitle className="text-lg">
                    Module {moduleIndex + 1}{module.name ? `: ${module.name}` : ''}
                  </CardTitle>
                  {modules.length > 1 && (
                    <Button type="button" variant="ghost" size="sm" className="text-gray-500 hover:text-red-600" onClick={() => removeModule(module.id)}>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-3 border-t border-gray-200 pt-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Button type="button" onClick={() => addTopic(module.id)} variant="outline" size="sm" className="border-gray-200 text-gray-600 hover:bg-gray-100">
                  ...
                  {module.topics.map((topic, topicIndex) => (
                    <div key={topic.id} className="space-y-3 rounded-lg border border-gray-200 bg-gray-50 p-4">
                      <div className="mb-2 flex items-center justify-between">
                        <span className="text-sm font-medium text-gray-600">Topic {topicIndex + 1}</span>
                        <Button type="button" variant="ghost" size="sm" className="text-gray-500 hover:text-red-600" onClick={() => removeTopic(module.id, topic.id)}>
                      ...
                      <Input
                        ...
                        onChange={(e) => updateTopic(module.id, topic.id, 'video_url', e.target.value)}
                      ...
                      <Textarea
                        ...
                        onChange={(e) => updateTopic(module.id, topic.id, 'overview', e.target.value)}
        ...
        <div className="flex justify-end gap-4">
          <Button type="button" variant="outline" onClick={() => router.push('/admin/dashboard')} disabled={loading} className="border-gray-200 text-gray-600 hover:bg-gray-100">
            Cancel
          </Button>
