...
GRANT SELECT ON courses, modules, topics, coding_problems, leaderboard, point_events, xp_events, achievements, user_achievements, daily_streaks, quests, user_quest_progress, seasons, season_leaderboard_snapshots TO authenticated;
